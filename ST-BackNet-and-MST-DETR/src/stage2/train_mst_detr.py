# -*- coding: utf-8 -*-
"""Train and evaluate MST-DETR for tropical-disturbance detection.

The model combines GridSat imagery and 28 ERA5 channels through gated feature
fusion, encodes four consecutive time steps with a lightweight 3D-CNN context
module, and applies DETR detection and lead-time heads. The ERA5 selection keeps
t500 and t850 while retaining all configured u, v, w and q pressure levels.
"""
...
class Config:
    # ---------------- Output ----------------
    OUTPUT_DIR = str(OUTPUT_ROOT / "training" / "mst_detr")
    ...
    # Mode options: "train_and_test" or "test".
    Mode = "train_and_test"
    # Mode = "test"
...
def run_single_seed(seed: int) -> Dict[str, Any]:
    ...
    print("--- Multi-Modal ST-DETR (GatedAFM + 3D-CNN ST Context + ERA5 KEEP28: t500/t850 only) | seed={} ---".format(seed))
    ...
    print("ST context fusion         : lightweight 3D-CNN encoder + gated residual into current feature")
